"""
Django settings for ighublmsplatform project.
...
SECRET_KEY = 'django-insecure-yfqp)wb@+*=#es-0q+tk6ia)_dfb-ifd5ydrut6h%#x1&$k6f^'
...
CSRF_TRUSTED_ORIGINS = ['https://ighub-lms.up.railway.app']
...
ROOT_URLCONF = 'ighublmsplatform.urls'
